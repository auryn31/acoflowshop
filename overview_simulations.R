overview <- read.csv(file="overview_simulations.csv", header=TRUE, sep=",")

jpeg("overview_avg_simulations.jpeg")
...
title(main="", xlab="Jobanzahl", ylab="Simulationsanzahl", font.main=4, cex.lab=1.4, cex.axis=1.4, cex.main=1.4, cex.sub=1.4)

overview <- read.csv(file="overview.csv", header=TRUE, sep=",")

jpeg("overview_avg_compl_time.jpeg")
...
title(main="", xlab="Jobanzahl", ylab="durchschnittliche Fertigstellungszeit", font.main=4, cex.lab=1.4, cex.axis=1.4, cex.main=1.4, cex.sub=1.4)

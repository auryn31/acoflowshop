...
title(main='Ameisenfaktor 50 Jobs',xlab='Iteration', ylab='durchschnittliche Fertigstellungszeit', font.main=4, cex.lab=1.4, cex.axis=1.4, cex.main=1.4, cex.sub=1.4)
...
title(main='Ameisenfaktor 50 Jobs', xlab='Laufzeit in s', ylab='durchschnittliche Fertigstellungszeit', font.main=4, cex.lab=1.4, cex.axis=1.4, cex.main=1.4, cex.sub=1.4)
legend("topright", legend=c("0.01", "0.1", "0.3", "0.4", "0.5", "0.6", "0.7", "0.8", "0.9", "1.0"), 
    col=c("blue", "green", "chocolate1", "burlywood3", "aquamarine4", "lightblue2", "magenta1", "olivedrab1", "purple2", "yellow2"),
    lty=1:1, cex=0.9)